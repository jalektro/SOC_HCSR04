...
entity design_1 is
  ...
  attribute CORE_GENERATION_INFO of design_1 : entity is "design_1,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=design_1,x_ipVersion=1.00.a,x_ipLanguage=VHDL,numBlks=3,numReposBlks=3,numNonXlnxBlks=0,numHierBlks=0,maxHierDepth=0,numSysgenBlks=0,numHlsBlks=0,numHdlrefBlks=1,numPkgbdBlks=0,bdsource=USER,da_board_cnt=1,da_clkrst_cnt=2,synth_mode=Hierarchical}";
  attribute HW_HANDOFF : string;
  attribute HW_HANDOFF of design_1 : entity is "design_1.hwdef";
end design_1;

architecture STRUCTURE of design_1 is
  component design_1_HCSR04_0_0 is
  port (
    clk : in STD_LOGIC;
  ...
  end component design_1_HCSR04_0_0;
  ...
  signal HCSR04_0_centimeter : STD_LOGIC_VECTOR ( 15 downto 0 );
  signal HCSR04_0_sonar_trig : STD_LOGIC;
...
begin
  ...
  sonar_trig_0 <= HCSR04_0_sonar_trig;
  sys_clock_1 <= sys_clock;
HCSR04_0: component design_1_HCSR04_0_0
     port map (
      centimeter(15 downto 0) => HCSR04_0_centimeter(15 downto 0),
      clk => clk_wiz_0_clk_out1,
      sonar_echo => sonar_echo_0_1,
      sonar_trig => HCSR04_0_sonar_trig
    );
...
vio_0: component design_1_vio_0_0
     port map (
      ...
      probe_in0(15 downto 0) => HCSR04_0_centimeter(15 downto 0)
    );
end STRUCTURE;
